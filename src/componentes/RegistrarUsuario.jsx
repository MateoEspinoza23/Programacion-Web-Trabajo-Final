...
const RegistrarUsuario = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (!contraseña) {
            ...
            setErrorContraseña("Mínimo 6 caracteres");
            valido = false;
        }

        if (!contraseña2) {
            setErrorContraseña2("Confirma tu contraseña");
            valido = false;
        } else if (contraseña !== contraseña2) {
            setErrorContraseña2("Las contraseñas no coinciden");
            valido = false;
        }
        ...
        <div className="registro-page">
            <Card className="registro-card">
                <CardContent>
                    ...
                    {error && (
                        <Alert severity="error" className="registro-alerta">
                            {error}
                        </Alert>
                    )}

                    {success && (
                        <Alert severity="success" className="registro-alerta">
                    ...
                    <Typography variant="body2" className="registro-switch">
                        ¿Ya tienes cuenta?{" "}
                        <span onClick={() => navigate("/LoginUsuario")}>
                            Inicia sesión
                        </span>
                    </Typography>
                </CardContent>
